    ...
    void testFactory() {
        ...
        builder.triggers.values().each {
            CustomTriggerFactoryBean factory = new CustomTriggerFactoryBean(
                    triggerClass: it.triggerClass,
                    triggerAttributes: it.triggerAttributes)
            factory.afterPropertiesSet()
            Trigger trigger = factory.object
            triggers[trigger.key.name] = trigger
        }

        assert triggers.simple instanceof SimpleTrigger
        SimpleTrigger simpleTrigger = triggers.simple
        ...
        CronTrigger cronTrigger = triggers.cron
        ...
        DailyTimeIntervalTrigger customTrigger = triggers.custom
